import 'package:e_commerce_with_supabase/features/view/main_pages/onboardimg/page_view.dart';
...
import '../../features/view/entry_pages/about_app/aboutapp.dart';
...
class Routes {
  static Map<String, Widget Function(BuildContext)> routes = {
    '/': (context) =>
        Supabase.instance.client.auth.currentUser != null ? BNV() : const PageViewDemo(),
